  ...
  return (
    <div className="bg-white/95 rounded-lg shadow-premium border border-black/[0.04] p-5">
      ...
      <textarea
        ...
        rows={12}
        className="w-full resize-none rounded-md border border-border/80 bg-zinc-50/80 px-4 py-3 text-[15px] leading-relaxed text-main placeholder:text-muted/50 focus:bg-white focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/40 disabled:opacity-60 transition-all"
      />
      {onOptimize && (
